...
module private Utils =
    ...
    let private localToVariable (ctx: EmitCtx) idx = ctx.Locals[idx]
    ...
    let private emitMethodToInstanceFunc (ctx: EmitCtx) (method: MethodReference) =
...
/// The Public API for the Emitter
module Emit =
