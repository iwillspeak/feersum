...
/// server framework. It is used to proactively communciate with the client
/// e.g. to publish diagnostics or send window messages.
type private FeersumClient(notificationSender: ClientNotificationSender, requestSender: ClientRequestSender) =
    inherit LspClient()
